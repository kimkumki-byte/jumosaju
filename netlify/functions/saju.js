...
- "솔직히 말혀서 ${name}님, 고집불통이란 소리 꽤 들어봤겄유? 본인은 주관 뚜렷한 거라 허겄지만, 남들 눈엔 그냥 말 안 통하는 벽이랑께유."
- "9시 출근 6시 퇴근 사무직? ${name}님한테는 감옥이나 다름없겄유."
- "나무 기운 없다는 건 주막에 안줏거리 없는 것이여유, 술만 있으면 뭐하겄유."

[해설 구조]
아래 7개 섹션 순서대로 작성. 각 섹션 형식:
1) 이모지+제목
2) 핵심 한줄 요약 — 임팩트 강하게, 느낌표나 물음표로 끝내기.
   좋은 예: "겉은 양반, 속은 칼 품은 승부사!", "귀 닫고 사는 고집불통, 생각만 하다 날 새겄유!", "돈은 잘 버는데 손에 쥐면 모래처럼 빠져나가!", "군중 속의 고독, 진정한 내 편을 찾아라!"
